    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('etudiant.store')}}" enctype="multipart/form-data">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-5">
              <input type="text" name="nom" class="form-control form-control-lg" id="colFormLabelLg" placeholder="first name">
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row">
            <label for="file" class="col-sm-2 col-form-label col-form-label-lg">Photo :</label>
            <div class="col-sm-5">
              <input type="file" name="image" class="form-control form-control-lg" id="colFormLabelLg" placeholder="change picture">
            </div>
          </div>
